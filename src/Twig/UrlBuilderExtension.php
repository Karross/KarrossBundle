...
{
    public function __construct(private readonly EntityMetadataRegistry $registry, private readonly UrlGeneratorInterface $urlGenerator)
    {
        $this->accessor = PropertyAccess::createPropertyAccessor();
    }

    #[AsTwigFunction('getUrl')]
    public function getUrl(string $action, array $association, $entity): string
    {
        try {
